...
<div class="d-flex align-items-center justify-content-between">
    <div class="bread-crumbs overflow-auto" style="max-width: 100%; white-space: nowrap;">
        ...
        <a href="{{route(    getUserRole().'.proposals')}}">My Proposals</a>
        <i class='bx bx-chevron-right' ></i>
        ...
        <div class="col col-lg-5 mb-4">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="sub_type">Type of Matter or Proposal</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="action">Requested Action</label>
                            <div class="input-group input-group-merge">
